...
const AdvertsListItem = (props) => {
  const { onAddFavoriteAdvert, setFavoriteIconColor } = useAddFavoriteAdverts();
      ...
      <li className={css.advertCard}>
        ...
        >
          <svg
            ...
            height="18"
            viewBox="0 0 18 18"
            fill={setFavoriteIconColor(carProps.id, 'fill')}
          ...
          >
            <path
              ...
              stroke={setFavoriteIconColor(carProps.id, 'stroke')}
              strokeOpacity="0.8"
              strokeWidth="1.5"
              strokeLinecap="round"
